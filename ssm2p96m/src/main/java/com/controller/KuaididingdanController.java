...
public class KuaididingdanController {
    ...
    public R page(@RequestParam Map<String, Object> params,KuaididingdanEntity kuaididingdan, 
		...
		if(tableName.equals("maijia")) {
			kuaididingdan.setMaijiazhanghao((String)request.getSession().getAttribute("username"));
		}
     ...
     */
    @RequestMapping("/list")
    public R list(@RequestParam Map<String, Object> params,KuaididingdanEntity kuaididingdan, HttpServletRequest request){
        EntityWrapper<KuaididingdanEntity> ew = new EntityWrapper<KuaididingdanEntity>();
		PageUtils page = kuaididingdanService.queryPage(params, MPUtil.sort(MPUtil.between(MPUtil.likeOrEq(ew, kuaididingdan), params), params));
        return R.ok().put("data", page);
    }
    ...
    public R save(@RequestBody KuaididingdanEntity kuaididingdan, HttpServletRequest request){
    	kuaididingdan.setId(new Date().getTime()+new Double(Math.floor(Math.random()*1000)).longValue());
	...
	public R remindCount(@PathVariable("columnName") String columnName, HttpServletRequest request, 
		...
		Wrapper<KuaididingdanEntity> wrapper = new EntityWrapper<KuaididingdanEntity>();
		if(map.get("remindstart")!=null) {
		...
		int count = kuaididingdanService.selectCount(wrapper);
